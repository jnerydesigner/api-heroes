...
npx prisma migrate deploy --schema=/usr/src/app/src/database/prisma/schema.prisma  
npx prisma generate --schema=/usr/src/app/src/database/prisma/schema.prisma  
