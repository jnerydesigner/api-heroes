...
var seedHero = function () { return __awaiter(void 0, void 0, void 0, function () {
    var _i, HeroesApi_1, hero;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, prisma_service_1.prisma.heroes.deleteMany()];
            case 1:
                _a.sent();
                _i = 0, HeroesApi_1 = heroes_data_1.HeroesApi;
                _a.label = 2;
            case 2:
                if (!(_i < HeroesApi_1.length)) return [3 /*break*/, 5];
                hero = HeroesApi_1[_i];
...
seedHero()
    ...
    switch (_a.label) {
        case 0: return [4 /*yield*/, prisma_service_1.prisma.$disconnect()];
